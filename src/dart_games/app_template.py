...
def create_ap(app, room_number):
    ...
    def layout_temp():
        ...
        string_out = gen_name_teams(dic["picked_players"], dic["teams"])
        tmp = gen_table(dic["picked_players"], dic["teams"])
        ...
        return html.Div(
            [
                ...
                html.Button(
                    "load game", id=f"submit-button-state-{room_number}", n_clicks=0
                ),
            ]
        )
